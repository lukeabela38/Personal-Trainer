...
- Added `personal_trainer/tests/test_script_entrypoints.py` to cover the snapshot CLI, Garmin speed report, and history artifact writer.
- The new test module exercises both the CLI success/error paths and the file-writing path for the history generator.
