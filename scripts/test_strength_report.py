...
class StrengthReportTests(unittest.TestCase):
    def test_build_report_prefers_best_set(self) -> None:
        raw = [
            {"exerciseTemplateId": "79D0BB3A", "workoutTitle": "A", "weight": 60, "reps": 8, "workoutStartTime": "2026-01-01T00:00:00Z"},
            {"exerciseTemplateId": "79D0BB3A", "workoutTitle": "B", "weight": 70, "reps": 4, "workoutStartTime": "2026-01-02T00:00:00Z"},
        ]
